...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['ids']) && isset($_POST['lec_names']) && isset($_POST['lec_durations'])) {
    ...
    echo "New Details Successfully Inputted into MongoDB Database";
}
?>
...
<section class="section main-section">
    <div class="card mb-6">
      <header class="card-header"></header>
        <p class="card-header-title button green">
          ...
          <?php echo "New Pack Successfully Created into the Pack Collection"; ?>
        </p>
		<br>
		<br>
		<hr>
    ...
    <label for="packId" class="label">Enter Pack ID:</label>
    <input type="text" id="packId" name="packId" class="input">
	<br>
	<br>
    <input type="submit" value="Search" class="button red">
</form>
