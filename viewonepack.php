...
// Assuming you're using MongoDB, given the `$cursor` usage in your provided code
/*$manager = new MongoDB\Driver\Manager("mongodb://localhost:27017");
$packId = $_POST['packId']; // get the ID from the submitted form

$filter = ['id' => $packId];
$options = []; // your query options if any

$query = new MongoDB\Driver\Query($filter, $options);
$cursor = $manager->executeQuery('ugc.Pack', $query); */
...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <h1 class="title">
      Details of the Inputted Park ID 
    </h1>
...
<section class="section main-section">
  ...
  <tr>
    <td width="30%" class="button green"><div class="label">Pack ID:</div></td>
    <td width="70%" class="button red"><div class="label"><?php echo $document->id; ?></div></td>
  </tr>
</table>
		</div>
		<div>
